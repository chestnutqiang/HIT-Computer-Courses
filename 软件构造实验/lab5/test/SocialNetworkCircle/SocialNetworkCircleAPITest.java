...
public class SocialNetworkCircleAPITest {
  ...
  public void testGetObjectDistributionEntropy() throws IOException {
    ...
    SocialNetworkCircle network1 = 
        new ConstractSocialNetwork("src/TXT/SocialNetworkCircle_Medium.txt").Constract();
  ...
  public void testGetDifference() throws IOException {
    ...
    Difference difference = caculate.getDifference(network, network1);
    assertEquals(1,difference.getTrackNum());
    List<Friend> f1 = difference.getObject1();
    assertEquals(9,f1.size());
    List<Integer> diff = difference.getObjectNum();
