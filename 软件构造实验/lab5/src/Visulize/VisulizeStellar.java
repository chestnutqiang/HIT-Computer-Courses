...
public class VisulizeStellar extends CircularOrbitHelper{
  
  private static ConcreteCircularOrbit system;
  static CircularOrbitHelper temp = new CircularOrbitHelper(); 
  /*
   * RI：
   ...
   * @param：c：一个行星轨道系统
   */
  public static void visualizeSystem(ConcreteCircularOrbit c) {
    JFrame look  = new JFrame("StellarSystem");;
    temp.setWindows(look);
    look.add(new guiDao());
  }
