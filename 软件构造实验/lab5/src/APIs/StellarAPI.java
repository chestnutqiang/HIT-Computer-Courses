...
public class StellarAPI implements CircularOrbitAPIs<PlanetWithSatellite>{
  ...
  public Difference getDifference(CircularOrbit c1, CircularOrbit c2) {
    ...
    ConcreteCircularOrbit system1 = (ConcreteCircularOrbit)c1;
    ConcreteCircularOrbit system2 = (ConcreteCircularOrbit)c2;
    List<PlanetTrack> track1 = system1.getTrack();
    List<PlanetTrack> track2 = system2.getTrack();
    ...
    List<PlanetWithSatellite> planets1 = new ArrayList<PlanetWithSatellite>();
    List<PlanetWithSatellite> planets2 = new ArrayList<PlanetWithSatellite>();
    ...
    Difference<PlanetWithSatellite> difference = new Difference<PlanetWithSatellite>(trackNum, 
        objectNum, planets1, planets2);
    return difference;
  }
}
