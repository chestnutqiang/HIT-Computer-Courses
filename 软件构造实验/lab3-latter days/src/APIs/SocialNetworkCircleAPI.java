...
public class SocialNetworkCircleAPI implements CircularOrbitAPIs<Friend>{
	...
	public Difference getDifference(CircularOrbit c1, CircularOrbit c2) {
		if(c1.getClass()!=c2.getClass())
			return null;
		SocialNetworkCircle system1=(SocialNetworkCircle)c1,system2=(SocialNetworkCircle)c2;
		List<SocialTrack> track1=system1.getTracks(),track2=system2.getTracks();
		...
		List<Friend> planets1=new ArrayList<Friend>(),planets2=new ArrayList<Friend>();
		...
		Difference<Friend> D=new Difference<Friend>(trackNum, objectNum, planets1, planets2);
		return D;
	}
